...
validate_recipe_outputs "khronos-opencl-icd-loader-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="khronos-opencl-icd-loader-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi